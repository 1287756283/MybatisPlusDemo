...
public class BigDecimalUtils {
    ...
    public static void main(String[] args) {
        JEP jep = new JEP();
        // 设置公式
        String expression = "(totalAmount +  proxy - award )";
        // 给变量赋值
        jep.addVariable("totalAmount",0.5);
        jep.addVariable("proxy",0.06);
        jep.addVariable("award",0.32);
        // 运算
    ...
    @Test
    void getResult() {
        BigDecimal result = getResult("0.5+0.06-0.32");
        System.out.println(result);
    }

    @Test
    public  BigDecimal getResult(String input){
        //规范输入形式,避免用户输入中文括号
    ...
    private List<String> changeInfixExpressionToPostfixExpression(String input) {
